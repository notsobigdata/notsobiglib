...
//
// Modules, in order: move.js model.js publish.js docs.js cli.js
var NotSoBigData = (function () {
  ...
  return {
    cli: cli,
    __test: { buildDocsPayload: buildDocsPayload, discoverNodesForTest: function () { return discoverNodes().nodes; }, renderDocsHtml: renderDocsHtml, computeBoardPositions: computeBoardPositions }
  };
})();
